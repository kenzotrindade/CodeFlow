...
export const metadata: Metadata = {
  ...
  description: "L'écosystème ultime pour les développeurs. Générez des défis d'ingénierie par IA et maîtrisez votre stack technique.",
};
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 pt-24 pb-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-purple-600/10 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-pink-600/10 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <Link href="/dashboard" className="btn-prism group relative">
            <span className="relative z-10 flex items-center gap-2">
              Lancer l'expérience <Zap className="w-4 h-4 fill-current" aria-hidden="true" />
            </span>
          </Link>
          <Link
            href="/techwatch"
      ...
      {/* Features Grid */}
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-[1900px] mb-32 relative z-10" aria-label="Fonctionnalités principales">
        {[
          {
          ...
          <article
            key={i}
            className="card-fragment group cursor-default p-8 hover:bg-white/[0.04] transition-all relative overflow-hidden"
          >
            <span className="text-8xl font-black opacity-[0.05] group-hover:opacity-[0.1] transition-opacity absolute -bottom-4 -right-4 italic select-none" aria-hidden="true">
              {item.index}
            </span>
            ...
            <div className="h-px w-0 group-hover:w-full bg-linear-to-r from-pink-500 to-transparent transition-all duration-700 mt-8" aria-hidden="true" />
          </article>
        ))}
      </section>

      {/* Philosophy Section */}
      <section className="w-full max-w-[1900px] mb-32 border-y border-white/10 py-20 flex flex-col md:flex-row gap-16 items-center">
        ...
        <aside className="flex-1 relative group" aria-hidden="true">
          <div className="w-full aspect-square border border-white/20 relative overflow-hidden bg-white/[0.02]">
      ...
      {/* Call to action */}
      <section className="text-center bg-linear-to-b from-transparent to-pink-500/5 w-full py-24 rounded-3xl border border-white/10 max-w-[1900px]">
